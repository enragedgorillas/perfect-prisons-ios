...
-(CGPoint) tilePosFromLocation:(CGPoint)location tileMap:(CCTMXTiledMap*)tileMap
{
    ...
    CGPoint endPointGroup;
    if(posWithinGroup.x <= 2){
        endPointGroup.x = -1;
    }else if(posWithinGroup.x <= 15){
        endPointGroup.x = 0;
    }else if(posWithinGroup.x < 29){
        endPointGroup.x = 1;
    }else if(posWithinGroup.x <= 47){
        endPointGroup.x = 2;
    }
    if(posWithinGroup.y <= 2){
        endPointGroup.y = -1;
    }else if(posWithinGroup.y <= 15){
        endPointGroup.y = 0;
    }else if(posWithinGroup.y < 29){
        endPointGroup.y = 1;
    }else if(posWithinGroup.y <= 47){
        endPointGroup.y = 2;
    }
